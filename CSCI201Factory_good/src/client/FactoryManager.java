...
public class FactoryManager implements Runnable , ChangeListener{
	...
	//needed to communicate back to the server
	...
	public void startRequestThread(){
		RequestThread rt = new RequestThread(fcl, this);
	}
	...
	public void loadFactory(Factory inFactory, JTable inTable) {
		...
		stop();
		mFactorySimulation = new FactorySimulation(mFactory, mTable);
		mFactorySimulation.getMailBox().loadListener(fcl);
