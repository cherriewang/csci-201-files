...
public class FactoryServerGUI extends JFrame {
	...
	private JButton infoFactoryButton;
	...
	private void initializeVariables() {
		...
		infoFactoryButton = new JButton(Constants.infoFactoryButtonString);
	}
	...
	private void createGUI() {
		...
		northPanel.add(infoFactoryButton);
	...
	private void addActionAdapters() {
		...
		infoFactoryButton.addActionListener(new InfoFactoryListener(selectFactoryComboBox));
	}
